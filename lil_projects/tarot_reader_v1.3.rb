...
def card_selection(user_time)
  ...
  loop do
    ...
    if VALID_CARDS.include?(card_input)
      ...
      prompt("Was it the #{VALID_CARDS.sample.capitalize} card?")
    else
...
def card_reading(card, card_orientation, time_period)
  ...
  loop do
    ...
    loop do
      ...
      print_empty_line
      puts "   1 - What's the meaning of the #{card_orientation.to_s.capitalize} #{card.capitalize} card?"
...
def feeling_lucky
  spread_array = VALID_CARDS.shuffle
  ...
  loop do
    ...
    print_empty_line
    puts "   1 - The Past: #{spread_hash[spread_array[0]].capitalize} #{spread_array[0].capitalize}"
    puts "   2 - The Present: #{spread_hash[spread_array[1]].capitalize} #{spread_array[1].capitalize}"
    puts "   3 - The Future: #{spread_hash[spread_array[2]].capitalize} #{spread_array[2].capitalize}"
